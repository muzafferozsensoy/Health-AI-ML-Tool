...
from routers import step1_clinical_context, step2_data_exploration, step3_data_preparation, step4_model_params, step6_explainability, step7_ethics_bias
...
def health():
    return {"status": "ok", "sprint": 4, "steps_implemented": [1, 2, 3, 4, 6, 7]}
